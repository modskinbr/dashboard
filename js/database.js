...
loginButton.addEventListener("click", (e) => {
    ...
    else if (username == "TaikunX3" && password == "04042006v") {
        localStorage.setItem("userdate", username );
        localStorage.setItem("validate", password );
        localStorage.setItem("data0", ID06.DiscordID);
        localStorage.setItem("data1", ID06.Nome);
        localStorage.setItem("data2", ID06.Imagem);
        localStorage.setItem("data3", ID06.Pontos);
        localStorage.setItem("data4", ID06.Rank);
        localStorage.setItem("data5", ID06.Rank_Image);
        localStorage.setItem("data6", ID06.Pontos_Miticos);
        localStorage.setItem("data7", ID06.Elo);
        localStorage.setItem("data8", ID06.Elo_Image);
        localStorage.setItem("data9", ID06.Destaque);
        localStorage.setItem("data10", ID06.Destaque_Image);
        localStorage.setItem("data11", ID06.Fragmentos);
        localStorage.setItem("data12", ID06.Fragmentos_Estelares);
        localStorage.setItem("data13", ID06.Essencia_Mitica);
        localStorage.setItem("data14", ID06.Moedas);
        localStorage.setItem("data15", ID06.Parceria);
        localStorage.setItem("data16", ID06.Cargo);
        localStorage.setItem("data17", ID06.Cargo_Image);
        localStorage.setItem("data18", ID06.Risco);
        localStorage.setItem("data19", ID06.Imune);
        localStorage.setItem("data20", ID06.Divulgacoes);
        localStorage.setItem("data21", ID06.Colaboracoes);
        localStorage.setItem("data22", ID06.Video);
        localStorage.setItem("data23", ID06.Contribuicoes_Federativa);
        localStorage.setItem("data24", ID06.Participacoes);
        localStorage.setItem("data25", ID06.Bonus_Extra);
        localStorage.setItem("data26", ID06.Contribuicoes_Tester);
        localStorage.setItem("data27", ID06.Tarefas);
        localStorage.setItem("data28", ID06.Verificacoes);
        localStorage.setItem("data29", ID06.Reputacao);
        localStorage.setItem("data30", ID06.Nasceu);
		localStorage.setItem("datap1", ID06.Obtido_recente);
		localStorage.setItem("datap2", ID06.Obtido2);
		localStorage.setItem("datap3", ID06.Obtido3);
		localStorage.setItem("datap4", ID06.Obtido4);
		localStorage.setItem("datap5", ID06.Obtido5);
		localStorage.setItem("datap6", ID06.Obtido6);
		localStorage.setItem("datap7", ID06.Obtido7);
		localStorage.setItem("datab1", ID06.Bonus_recente);
		localStorage.setItem("datab2", ID06.Bonus2);
		localStorage.setItem("datab3", ID06.Bonus3);
		localStorage.setItem("datab4", ID06.Bonus4);
		localStorage.setItem("datab5", ID06.Bonus5);
		localStorage.setItem("datab6", ID06.Bonus6);
		localStorage.setItem("datab7", ID06.Bonus7);
		localStorage.setItem("dataq1", ID06.Quantidade_recente);
		localStorage.setItem("dataq2", ID06.Quantidade2);
		localStorage.setItem("dataq3", ID06.Quantidade3);
		localStorage.setItem("dataq4", ID06.Quantidade4);
		localStorage.setItem("dataq5", ID06.Quantidade5);
		localStorage.setItem("dataq6", ID06.Quantidade6);
		localStorage.setItem("dataq7", ID06.Quantidade7);
        location.href = urlhref;
    } 
    else {
